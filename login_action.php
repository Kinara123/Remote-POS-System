...
if ($capt) {
    ...
    $sql = "SELECT id, f_name, email, phone, password, role, status FROM users WHERE email = ? AND role = ?";
            ...
            if ($stmt->num_rows == 1) {
                ...
                if ($stmt->fetch()) {
                    ...
                    if (password_verify($pass, $password)) {
                        if ($status == 1) {
                            ...
                            <strong>Welcome ' . $f_name . '!</strong> Check your email for the OTP for verificaton.
                            ...
                            <div class="alert alert-warning"><strong>Sorry!</strong> Your account is not approved yet!</div>
                            ';
                        }else {
                            echo '
                            <audio autoplay><source src="error.mp3"></audio>
                ...
                echo '
                    ...
                    <script>
                        $("#invalid_phrase").html("");
                        $("#valid_phrase").html("Looks good!");
                        $("#invalid_email").html("Invalid email address or wrong selected role!");
                    </script>';
            }
        } else {
            echo '
